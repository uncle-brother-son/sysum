...
class VariantSelects extends HTMLElement {
  ...
  updateVariantInput() {
    const productForms = document.querySelectorAll(
      `#product-form-${this.dataset.section}, #product-form-float-${this.dataset.section}, #product-form-installment-${this.dataset.section}`
    );
  ...
  toggleAddButton(disable = true, text, modifyClass = true) {
    const addButtonList = document.querySelectorAll('[name="add"]');
    const addButtonTextList = document.querySelectorAll('[name="add"] > span');

    addButtonList.forEach((button, index) => {
        const addButtonText = addButtonTextList[index];
